...
corruption_in_america = ["Texas","Georgia","Florida","New York","California","North Carolina","Maryland","Illinois"]
corruption_in_america.append("Washington DC")
corruption_in_america[2] = "Alaska"
print(corruption_in_america)